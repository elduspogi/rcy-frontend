      ...
      <div className="hero-content text-center z-20">
        <div className="md:max-w-xl lg:max-w-3xl">
          ...
          <div className="flex flex-row gap-4 md:gap-8 justify-center">
            <img src={RCYLogo} alt="Red Cross Youth Logo" className='w-1/2 size-full lg:size-60 blue-logo' data-aos="zoom-in" data-aos-delay="900" />
            <img src={SPCLogo} alt="Red Cross Youth Logo" className='w-1/2 size-full lg:size-60 red-logo' data-aos="zoom-in" data-aos-delay="1200" />
          </div>
        </div>
      </div>
    </div>
